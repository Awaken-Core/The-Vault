...
export const sendVerificationEmail = async ({ email, token, userId }: { email: string, token: string, userId: string }) => {
...
export const sendPasswordResetEmail = async ({ email, token, userId }: { email: string, token: string, userId: string }) => {
